<?php
/**
 * Plugin Name: Euro FxRef Currency Converter (by DKZR)
...
class EuroFxRef {
	...
	public static function currency_legal_shortcode( $atts ) {
		...
		if ( $atts['prepend'] ) {
			$output = sprintf( '<span class="eurofxref-prepend-string">%s</span>', wp_filter_post_kses( $atts['prepend'] ) );
		}
